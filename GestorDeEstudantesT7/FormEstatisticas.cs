...
namespace GestorDeEstudantesT7
{
    public partial class FormEstatisticas : Form
    {
        ...
        private void labelTotalDeEstudantes_MouseEnter(object sender, EventArgs e)
        {
            ...
            panelTotalDeEstudantes.BackColor = Color.Orange;
            labelTotalDeEstudantes.ForeColor = Color.OrangeRed;
        }
        ...
        private void labelMeninos_MouseEnter(object sender, EventArgs e)
        {
            ...
            labelMeninos.ForeColor = Color.Blue;
        }
        ...
        {
            panelMeninas.BackColor = Color.Pink;
            labelMeninas.ForeColor = Color.HotPink;
        }
